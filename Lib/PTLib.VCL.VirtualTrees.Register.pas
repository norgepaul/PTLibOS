unit PTLib.VCL.VirtualTrees.Register;
...
uses
  System.SysUtils, DesignIntf, DesignEditors,
  System.Classes,

  PTLib.VCL.VirtualTrees,
  PTLib.VCL.VirtualTrees.Log,
  PTLib.VCL.VirtualTrees.TextHighlightTree,

  PTLib.VCL.VirtualTrees.Frames.SearchLog,
  PTLib.VCL.VirtualTrees.Frames.Logs;
...
const
  ComponentsTab = 'PTLib VirtualTrees';
...
begin
  ...
  RegisterComponents(ComponentsTab, [
    TPTLibVirtualTree,
    TPTLibVirtualLogTree,
    TPTLibTextHighlightTree,
    TframeLogs,
    TframeSearchLog
  ]);
end;
