...
uses
  ...
  PTLib.VCL.HTMLLinkLabel,
  PTLib.VCL.Console,
  PTLib.VCL.PageControl,

  PTLib.VCL.Register.Editors;
...
begin
  ...
  RegisterComponentEditor(TAwesomeEdit, TAwesomeEditButtonEditor);
end;
